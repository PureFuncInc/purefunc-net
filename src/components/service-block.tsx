...
export default function ServiceBlock() {
  return (
    <section className={`mx-48 flex flex-col`}>
      ...
      <div className={`flex flex-wrap justify-center gap-8 text-[#FFFFFF]`}>
        <div className={`flex w-[512px] flex-col`}>
          <p className={`text-2xl font-medium text-purefunc-2`}>軟體技術顧問</p>
          <p>超過十載產業耕耘的菁英團隊，擁有多元技術實力與豐沛實作經驗，涵蓋前端、後端、行動端、系統架構、DevOps 與自動化測試等領域。我們提供全方位的顧問諮詢服務，為客戶打造最佳化的科技解決方案。</p>
        </div>
        <div className={`flex w-[512px] flex-col`}>
          <p className={`text-2xl font-medium text-purefunc-2`}>客製化 APP 開發</p>
          <p>專精跨平台混合應用程式開發，著重 React Native 和 Flutter 等技術。高度重視客戶需求，全面考量最優方案，如視情況以 Progressive Web App 取代行動應用程式。</p>
        </div>
        <div className={`flex w-[512px] flex-col`}>
          <p className={`text-2xl font-medium text-purefunc-2`}>客製化系統開發</p>
